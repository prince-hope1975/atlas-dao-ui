								...
								<Row>
									<AttributesCard>
										<AttributeCard>
											...
											{Math.floor((acceptedLoanOffer?.offerInfo?.terms?.durationInBlocks ?? 
										...
										<AttributeCard>
											...
											<AttributeValue>
												...
												{amountConverter.default.blockchainValueToUserFacing(
															acceptedLoanOffer?.offerInfo?.terms?.totalAmountToRepay ??
																loanInfo?.terms?.totalAmountToRepay ?? 0).toFixed(3)}
												{acceptedLoanOffer?.offerInfo?.terms?.principle?.currency ??
														loanInfo?.terms?.principle?.currency ?? ''}
												<Box sx={{ ml: 8 }}>
													<LunaIcon />
