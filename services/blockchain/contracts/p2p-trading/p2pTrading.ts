...
// 				previewNFT,
// 			}) => {
// 				const p2pContractAddress = networkUtils.getContractAddress(
...
// 			}
// 		)
// 		return networkUtils.postManyTransactions(txs.flat())
// 	}
...
// 								denom: networkUtils.getDenomForCurrency(currency.toLowerCase()),
// 							},
// 						},
// 						trade_id: tradeId,
// 					},
...
// 		return networkUtils.postManyTransactions(txs)
// 	}
...
// 		counterId?: number
// 	): Promise<TxReceipt> {
// 		const cw20ContractAddress = networkUtils.getContractAddress(token)
// 		const p2pContractAddress = networkUtils.getContractAddress(
// 			CONTRACT_NAME.p2pTrade
// 		)
// 		const requiredAmount = amountConverter.userFacingToBlockchainValue(amount)
...
// 		counterId?: number
// 	): Promise<TxReceipt> {
// 		const cw721ContractAddress = networkUtils.getContractAddress(token)
// 		const p2pContractAddress = networkUtils.getContractAddress(
// 			CONTRACT_NAME.p2pTrade
// 		)
...
// 		const feeContractAddress = networkUtils.getContractAddress(
// 			CONTRACT_NAME.feeCollector
// 		)

// 		const feeResponse = await networkUtils.sendQuery(feeContractAddress, {
...
// 			await networkUtils.sendQuery(feeContractAddress, {
// 				fee: {
// 					trade_id: tradeId,
// 					counter_id: counterId,
// 				},
...
// 						({ cw721Coin, coin, Sg721Token }) => ({
// 							sg721_token: keysToSnake(Sg721Token),
