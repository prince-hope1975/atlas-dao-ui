    ...
    <ContentCardWrapper>
      <ContentCard>
        ...
        <FormWrapper>
          <Box sx={{ pt: "8px" }}>
            ...
            <Flex sx={{ flexDirection: ["column", "row"], gap: [0, "16px"] }}>
              ...
              <TokenInputField
                ...
                placeholder={`Enter amount of ${getValues('ticketPriceCurrency')} per ticket`}
            ...
            <TextAreaField
              ...
              id="comment"
              {...register("comment")}
              fieldError={errors.comment && `${errors?.comment?.message}`}
          ...
          <AccordionCard
            title="Terms & Conditions" // {t('raffle:raffle-details.terms-title')}
          >
