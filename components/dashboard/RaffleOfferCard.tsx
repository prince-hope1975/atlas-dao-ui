...
import RaffleStateBadge from '../shared/raffle/listing-card/RaffleStateBadge'
	...
	return (
		<Flex sx={{ flexDirection: 'column' }}>
						...
						>
							...
							>
								...
								<AttributeCard>
									<AttributeName isSmall={isSmall}>
										{
										// t(`raffle-listings:${moment().isAfter(endsIn) ? 'ended' : 'ends-in'}`)
			...
			<Flex sx={{ flex: 1, maxHeight: '40px' }}>
				...
				>
					{
					// t(`dashboard:raffles:${showingParticipants ? 'hide-participants' : 'see-participants'}`)
