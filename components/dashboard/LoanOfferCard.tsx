...
import { LoanStateBadge } from '../shared/loan/listing-card'
import { Badge, Button, OverflowTip } from '../ui'
		...
		<Flex sx={{ flexDirection: 'column' }}>
									...
									<Flex sx={{ width: '100%', justifyContent: 'space-between' }}>
										<Flex sx={{ flexDirection: 'column' }}>
											...
											<AttributeValue isSmall={isSmall}>
												<OverflowTip>
													<div>
														{/* {t('dashboard:loans.days', { count: timeFrame })} */}
														{timeFrame} Days
														</div>
												</OverflowTip>
											</AttributeValue>
			...
			<Flex sx={{ flex: 1, maxHeight: '40px' }}>
				...
				>
					...
					`${showingOffers ? 'hide-offers' : 'see-offers'}`
					}
				</Button>
			</Flex>
			{showingOffers && (
