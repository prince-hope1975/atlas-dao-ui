...
// import { CounterOffersTable } from '../trade-listing-details'
...
// 				>
// 					{
// 					// t(`dashboard:trades:${showingCounterTrades ? 'hide-offers' : 'see-offers'}`)
// 					`${showingCounterTrades ? 'hide-offers' : 'see-offers'}`
// 					}
// 				</Button>
// 			</Flex>
// 			{showingCounterTrades && (
