		...
		<Flex sx={{ flexDirection: 'column', gap: '16px' }}>
			<ContentCard sx={{ padding: ['16px 12px 32px', '24px 12px 40px'] }}>
				...
				>
					...
					<SuccessTitle>
						{/* {t('loan:confirm-listing.congratulations')} */}
						</SuccessTitle>
					<SuccessMessage>
			...
			>
				<Box>
					<SuccessLabel>
						{/* {t('loan:confirm-listing.your-listing-url')} */}
				...
				<Box>
					<SuccessLabel>
						{/* {t('loan:confirm-listing.transaction-id')} */}
				...
				<If.Else>
					<ContentCard>
						...
						<Box>
							...
							>
								<StepTitle>
									{/* {t('loan:confirm-listing.loan-details')} */}
						...
						<Box>
							...
							>
								<StepTitle>
									{/* {t('loan:confirm-listing.comments')} */}
								</StepTitle>
							</StepHeader>
							<Box pb='24px' style={{ width: 'fit-content' }}>
								{selectedComment ? (
									...
									<NoContent>
										{/* {t('loan:confirm-listing.no-content-comments')} */}
										</NoContent>
								)}
							</Box>
						</Box>
