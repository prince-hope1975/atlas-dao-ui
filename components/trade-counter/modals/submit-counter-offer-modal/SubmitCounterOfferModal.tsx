					...
					<ModalLayoutContainer>
						<ModalContent>
							...
							<ModalBody>
								<Box>
									<Title>
										{/* {t('trade-listings:submit-counter-offer-modal.answer')} */}
										You&apos;ll be able to remove your offer but only if its not accepted by the listing owner.				
										</Title>
								</Box>
								...
								>
									...
									>
										<Title>
											...
											{getShortText(trade?.tradeInfo?.owner, 6)}
										</Title>
										<Grid>
											{tradeNFTs.map(nft => (
												<PreviewImageContainer
