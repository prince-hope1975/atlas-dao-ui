...
const RemoveModal = NiceModal.create(({ raffleId }: RemoveModalProps) => {
							...
							<ModalBody>
								<Flex sx={{ gap: '8px' }}>
									...
									<Flex sx={{ flex: 1, flexDirection: 'column' }}>
										<Title>
{/* {t('raffle-listings:remove-modal.question')} */}

</Title>
										<Subtitle>
											{/* {t('raffle-listings:remove-modal.answer')} */}
								...
								>
									<RadioCard value={CONFIRM_STATUS_TYPE.CONFIRMED}>
										<RadioText>
											{/* {t('raffle-listings:remove-modal.radio-text')} */}
								...
								>
									<Button variant='secondary' fullWidth onClick={modal.remove}>
										{/* {t('raffle-listings:remove-modal.back-to-listing')} */}
									</Button>
									<Button
										variant='destructive'
										fullWidth
										...
										onClick={onRemove}
									>
										{/* {t('raffle-listings:remove-modal.remove-listing')} */}
									</Button>
								</Flex>
							</ModalBody>
						</ModalBody>
