										...
										<Flex sx={{ flexDirection: 'column', gap: '24px' }}>
											<Flex sx={{ flexDirection: 'column' }}>
												<Title>
													...
													Are you sure you’d like to accept the offer from 
												{getShortText(counterTrade?.tradeInfo.owner ?? '', 8)}

												</Title>
												<Subtitle>
													{/* {t('trade-listings:accept-counter-offer-modal.note')} */}
													Feel free to include a message. How exciting!
												</Subtitle>
											</Flex>
											...
											>
												...
												>
													<Title>
														...
														{getShortText(counterTrade?.tradeInfo?.owner, 6)}&apos;s offer
													</Title>
													<Grid>
											...
											<Flex sx={{ flexDirection: 'column' }}>
												<TextAreaField
													label='Send Message' // {t('trade-listings:accept-counter-offer-modal:send-message')}
													id='comment'
													style={{ height: '128px' }}
													{...register('comment')}
