...
// export const STARGAZE_GRAPHQL_ENDPOINT = `https://constellations-api.mainnet.stargaze-apis.com/graphql`;
export const STARGAZE_GRAPHQL_ENDPOINT = `https://constellations-api.testnet.stargaze-apis.com/graphql`;
