...
// export const TRADE_LISTINGS = '/trade-listings'
// export const TRADE_LISTING_DETAILS = '/trade-listing-details'
...
// SOCIALS
export const DISCORD = 'https://discord.gg/tVyxjKUG6f'
export const TELEGRAM = ''
export const TWITTER = 'https://twitter.com/atlasdao_'
export const MEDIUM = ''
